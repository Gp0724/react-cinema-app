...
# # added after getting error, prolly had missed
# resource "aws_cloudfront_origin_access_identity" "cinema_app_origin_access" {
#   comment = "OAI for Cinema App CloudFront Distribution"
# }
...
data "aws_iam_policy_document" "bucket_policy_document" {
  statement {
    ...
    principals {
      type = "AWS"
      identifiers = [
        aws_cloudfront_origin_access_identity.cinema_app_origin_access.iam_arn
      ]
    }
  }
}
